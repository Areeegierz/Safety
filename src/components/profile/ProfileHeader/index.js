        ...
        <div className="gx-profile-banner-top">
          <div className="gx-profile-banner-top-left">
            ...
            <div className="gx-profile-banner-avatar-info">
              ...
              <p className="gx-mb-0 gx-fs-lg">CPAC METRO</p>
            </div>
          </div>
          <div className="gx-profile-banner-top-right">
            <ul className="gx-follower-list">
              <li>
                ...
                <span className="gx-fs-sm">สิ่งผิดปกติ (ข้อ)</span>
              </li>
              <li>
                <span className="gx-follower-title gx-fs-lg gx-font-weight-medium">
                  847
                </span>
                <span className="gx-fs-sm">แก้ไข้แล้ว (ข้อ)</span>
              </li>
              <li>
                <span className="gx-follower-title gx-fs-lg gx-font-weight-medium">
                  327
                </span>
                <span className="gx-fs-sm">คงเหลือ (ข้อ)</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="gx-profile-banner-bottom">
          <div className="gx-tab-list">
            <ul className="gx-navbar-nav">
              <li>
                <span className="gx-link">ประเมิน Line Walk ไปแล้ว 10 รอบ</span>
              </li>
              {/* <li>
